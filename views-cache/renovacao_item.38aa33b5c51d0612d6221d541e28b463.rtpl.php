                        ...
                        <div class="box-body" >
                                ...
                                <div class="campos_form"  style="display: flex;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo htmlspecialchars( $empr["url_img"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="width: 25%;"><br>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>Data de Devolução:</label>
                                        ...
                                        <input type="date" class="form-control" id="data_devol" name="data_devol" placeholder="Digite a data de devolução">
