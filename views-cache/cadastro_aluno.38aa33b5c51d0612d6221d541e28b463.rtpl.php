            ...
            <form role="form" action="/admin/cadastra/aluno" method="post">
                        ...
                        <div class="box-body" >
                                ...
                                <div class="campos_form">
                                    ...
                                    <input type="text" class="form-control" id="nomr" name="nome" placeholder="Digite o nome" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="vlprice">Matrícula</label><br>
                                    <input type="value" class="form-control" id="matricula" name="matricula" placeholder="Digite a matrícula escolar" onchange="verifica_matricula()" required>
                                    </div>
                                </div>
                                ...
                                <div class="campos_form">
                                    ...
                                    <input type="text" class="form-control" id="turma" name="turma" placeholder="Digite a turma e ano"  required>
                                    </div>
                                </div>
                                ...
                                <div class="campos_form">
                                    ...
                                    <input type="mail" class="form-control" id="email" name="email" name="vlheight" placeholder="Digite o email para contato" required>
                                    </div>
                                </div>
                        </div>
                        <!-- /.box-body -->
