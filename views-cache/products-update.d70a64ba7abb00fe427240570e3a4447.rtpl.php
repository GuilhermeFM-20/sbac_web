  	...
  	<div class="col-md-12">
        ...
        <form role="form" action="/admin/products/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="box box-widget">
                <div class="box-body">
                  <img class="img-responsive" id="image-preview" src="<?php echo htmlspecialchars( $product["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="Photo" width="200" height="200">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-footer">
            <a href="/admin/products"><button type="button" class="btn btn-primary">Voltar</button></a>
