<?php if(!class_exists('Rain\Tpl')){exit;}?>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url(/sbac_web/views/img/bg-img/bg-1.jpg);">
            ...
            <div class="single-hero-slide bg-img" style="background-image: url(/sbac_web/views/img/bg-img/ab.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
    ...
    <div class="academy-courses-area section-padding-100-0">
            <div class="container">
                <h1>História da nossa escola</h1><br>
                       <div id="imgp"> <td><img src="/sbac_web/views/img/bg-img/prof.jpg" alt="" height="200" width="200" style="border-radius: 30px;"></div>
    ...
    <div class="testimonials-area section-padding-100 bg-img bg-overlay" style="background-image: url(/sbac_web/views/img/bg-img/bg-2.jpg);">
        <div class="container">
